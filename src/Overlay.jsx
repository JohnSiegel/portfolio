  ...
  >
    ...
    <div style={{ height: isMobile ? "150vh" : "130vh" }}>
      <div className="blob" style={{maxWidth: "600px"}}>
        ...
        />
        <p>Hi, I'm John. I started programming in 2012 when I was 12 years old. As a kid, I always found myself more fascinated with how video games were created than the actual games themselves. Because of this fascination I was constantly trying to learn more about software. I taught myself Java in my teennage years and was making money by creating Minecraft Server plugins before I ever took a programming class.</p>
